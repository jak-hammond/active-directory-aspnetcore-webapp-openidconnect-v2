...
namespace Microsoft.Identity.Web.Test
{
    internal static class TestConstants
    {
        ...
        public const string AuthorityOrganizationsTenantWithV2 = AadInstance + "/organizations/v2.0";
        public const string AuthorityOrganizationsUSTenantWithV2 = AadInstance + "/organizations/v2.0";
